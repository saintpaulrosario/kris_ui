...
class DialectMenuWiget extends StatefulWidget {
  const DialectMenuWiget({super.key});

  @override
  State<DialectMenuWiget> createState() => _ScriptMenuWidgetState();
}

class _ScriptMenuWidgetState extends State<DialectMenuWiget> {
