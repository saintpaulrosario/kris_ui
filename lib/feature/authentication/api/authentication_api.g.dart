...
class _AuthenticationApi implements AuthenticationApi {
  ...
  Future<HttpResponse<ApiResult<RegisterResponse>>> register(
    ...
    final _options = _setStreamType<HttpResponse<ApiResult<RegisterResponse>>>(
    ...
    late ApiResult<RegisterResponse> _value;
    try {
      _value = ApiResult<RegisterResponse>.fromJson(
        _result.data!,
  ...
  Future<HttpResponse<ApiResult<AuthenticateResponse>>> login(
    ...
    _data.addAll(request.toJson());
    final _options =
        _setStreamType<HttpResponse<ApiResult<AuthenticateResponse>>>(
          Options(method: 'POST', headers: _headers, extra: _extra)
              .compose(
                _dio.options,
                '/authentication',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResult<AuthenticateResponse> _value;
    try {
      _value = ApiResult<AuthenticateResponse>.fromJson(
        _result.data!,
  ...
  Future<HttpResponse<ApiResult<String>>> confirmEmail(
    ...
    final _options = _setStreamType<HttpResponse<ApiResult<String>>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResult<String> _value;
    try {
      _value = ApiResult<String>.fromJson(
        _result.data!,
        (json) => json as String,
      );
    } on Object catch (e, s) {
