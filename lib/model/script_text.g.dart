...
part of 'script_text.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ScriptText _$ScriptTextFromJson(Map json) => $checkedCreate(
  'ScriptText',
  json,
  ($checkedConvert) {
    final val = ScriptText(
...
Map<String, dynamic> _$ScriptTextToJson(ScriptText instance) =>
    <String, dynamic>{
