...
//     implements WordService<Word, WordText, WordContent, WordPayload> {
...
//     final HttpResponse<ApiResult<WordText>> httpResponse = await _api
//         .fetchForText(sku);
//     try {
...
//     String sku,
//   ) async {
//     final HttpResponse<ApiResult<WordContent>> httpResponse = await _api
//         .fetchForContent(sku);
//     try {
...
//     String sku,
//   ) async {
//     final HttpResponse<ApiResult<WordPayload>> httpResponse = await _api
//         .fetchForPayload(sku);
//     try {
