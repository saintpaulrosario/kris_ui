...
// class DialectBloc extends Bloc<BaseEvent, BaseState<Dialect>> {
//   final _service = getIt<WordService<Dialect>>();
...
//       final results = await _service.word(event.identifier.sku);
