...
class _TypeApi implements TypeApi {
  _TypeApi(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<HttpResponse<ApiResult<PageResult<w.Type>>>> fetchAll({
    ...
    final _options = _setStreamType<HttpResponse<ApiResult<PageResult<w.Type>>>>(
    ...
    late ApiResult<PageResult<w.Type>> _value;
    try {
      _value = ApiResult<PageResult<w.Type>>.fromJson(
        _result.data!,
        (json) => PageResult<w.Type>.fromJson(
          json as Map<String, dynamic>,
          (json) => w.Type.fromJson(json as Map<String, dynamic>),
        ),
      );
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<ApiResult<w.Type>>> fetch({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ApiResult<w.Type>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/type/${identifier}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResult<w.Type> _value;
    try {
      _value = ApiResult<w.Type>.fromJson(
        _result.data!,
        (json) => w.Type.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<ApiResult<w.Type>>> retrieveWordByTrait({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ApiResult<Type>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
