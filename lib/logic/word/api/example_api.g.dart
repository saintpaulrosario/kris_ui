...
class _ExampleApi implements ExampleApi {
  ...
  Future<HttpResponse<ApiResult<PageResult<Example>>>> fetchAll({
    ...
    final _options =
        _setStreamType<HttpResponse<ApiResult<PageResult<Example>>>>(
    ...
    late ApiResult<PageResult<Example>> _value;
    try {
      _value = ApiResult<PageResult<Example>>.fromJson(
        _result.data!,
        (json) => PageResult<Example>.fromJson(
          json as Map<String, dynamic>,
          (json) => Example.fromJson(json as Map<String, dynamic>),
        ),
      );
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<ApiResult<Example>>> fetch({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ApiResult<Example>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/example/${identifier}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResult<Example> _value;
    try {
      _value = ApiResult<Example>.fromJson(
        _result.data!,
        (json) => Example.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<ApiResult<List<ExampleTrait>>>> fetchTraits({
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<HttpResponse<ApiResult<List<ExampleTrait>>>>(
          Options(method: 'GET', headers: _headers, extra: _extra)
              .compose(
                _dio.options,
                '/example/trait',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResult<List<ExampleTrait>> _value;
    try {
      _value = ApiResult<List<ExampleTrait>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                  .map<ExampleTrait>(
                    (i) => ExampleTrait.fromJson(i as Map<String, dynamic>),
                  )
                  .toList()
            : List.empty(),
      );
  ...
  Future<HttpResponse<ApiResult<ExampleTrait>>> fetchTrait({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ApiResult<ExampleTrait>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResult<ExampleTrait> _value;
    try {
      _value = ApiResult<ExampleTrait>.fromJson(
        _result.data!,
        (json) => ExampleTrait.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
