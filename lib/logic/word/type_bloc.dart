...
class TypeBloc
    extends Bloc<BaseEvent, BaseState<w.Type, Text, Content, Payload, Trait>> {
  final _service = getIt<TypeService>();

  TypeBloc() : super(BaseState.initial()) {
  ...
  Future<void> _fetchWords(BaseEvent event, Emitter emit) async {
    ...
    final Either<ErrorResponse, PageResult<w.Type>> results = await _service
        .retrieve(
          page: number,
          size: size,
          scripts: scripts,
