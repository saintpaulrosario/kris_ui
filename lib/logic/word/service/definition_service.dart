...
class DefinitionService
  ...
  @override
  Future<Either<ErrorResponse, PageResult<Definition>>> retrieve({
    int? page,
    int? size,
    List<String>? scripts,
    ...
    try {
      final HttpResponse<ApiResult<PageResult<Definition>>> httpResponse =
          await _api.fetchAll(
            page: page,
            size: size,
            scripts: scripts,
      ...
      ApiResult<PageResult<Definition>> apiResult = httpResponse.data;
      if (httpResponse.response.statusCode == 200) {
        final PageResult<Definition> payload = apiResult.payload;
  ...
  @override
  Future<Either<ErrorResponse, Definition>> retrieveWord({
    required Identifier identifier,
  }) async {
    final HttpResponse<ApiResult<Definition>> httpResponse = await _api.fetch(
  ...
  @override
  Future<Either<ErrorResponse, Definition>> retrieveWordByTrait({
    required Identifier identifier,
  }) async {
    try {
